...
/**
 * Safe diagnostic logger for v7 canary.
...
/**
 * Assert object has no sensitive string fields for tests.
...
/**
 * @param {ReturnType<typeof summarizeInbound>} summary
...
export function logInboundSafe(summary, upsertType) {
  ...
  console.log('[canary-inbound]', JSON.stringify(line));
  return line;
}
